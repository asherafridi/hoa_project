            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $workOrder->propertyId != null ? $workOrder->property()->name : 'Property Not Assigned' }}"
                            readonly />
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $workOrder->requestedBy != null ? $workOrder->requestedBy()->fullName() : 'Requested By Admin' }}"
                            readonly />
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $workOrder->assignedTo != null ? $workOrder->vendor()->name : 'Work not Assigned Yet' }}"
                            readonly />
                    </div>
                </div>
