                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" required name="email"
                            value="{{ $member->email }}" placeholder="john@gmail.com" autofocus />
                        @error('email')
                        <div class="form-text text-danger">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" required name="phone"
                            value="{{ $member->phone }}" placeholder="000-000-0000" autofocus />
                        @error('phone')
                        <div class="form-text text-danger">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" required name="userType">
                            ...
                            <option value="{{ $type->id }}" @if ($type->id == $member->userType) selected @endif>{{ $type->name }}</option>
                            @endforeach
                        </select>
                        @error('userType')
                        <div class="form-text text-danger">
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <select class="form-control" required name="status">
                            ...
                            <option value="0" @if ($member->status == 0) selected @endif>Non Approved</option>
