                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control bg-white" value="{{ $bill->type()->name }}"
                                    required name="title" placeholder="Arrangement" readonly />

                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" name="description" class="form-control border-none" placeholder="Description..."
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-white" required name="date"
                                    ...
                                    value="{{ $bill->amount }} {{ settings('currency_symbol') }}" />
                                @error('date')
                                    <div class="form-text text-danger">
                                        {{ $message }}
                                    </div>
