        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" value="{{ $workOrder->property() ? $workOrder->property()->name : 'Property Not Assigned' }}" readonly />
                </div>

                <div class="col-md-4">
                    <label class="form-label">Requested By</label>
                    <input type="text" class="form-control" value="{{ $workOrder->requestedBy() ? $workOrder->requestedBy()->fullName()  : 'Requested By Admin' }}" readonly />
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" value="{{ $workOrder->vendor() ? $workOrder->vendor()->name : 'Work Not Assigned' }}" readonly />
                </div>
            </div>
