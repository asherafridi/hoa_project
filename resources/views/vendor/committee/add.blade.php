...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Committee /</span> Create</h4>
                ...
                <form method="POST" action="{{ route('committee.store') }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" required name="name" placeholder="Arrangement"
                                autofocus />
                            @error('name')
